            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/xiaomi 11.png" alt="xiaomi 11">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>XIAOMI 11</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/flip 2.png" alt="flip 2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>SAMSUNG FLIP 2</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/fold 2.jpg" alt="fold 2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>SAMSUNG Z-FOLD 2</h3>
                                    <p>Price: Rs.1,00,000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/s20 ultra.png" alt="s20 ultra">
                            </a>
                            <center>
                                <div class="caption">
